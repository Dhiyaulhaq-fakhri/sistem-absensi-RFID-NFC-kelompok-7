 ...
 * @author Lenovo
 */
public class SidebarMenuPanel extends JPanel implements I18nServices.I18nChangeListener {
    ...
    private void switchModule(String moduleKey, JButton btn) {
        ...
        String targetModule = "";
        if (moduleKey.equals("ui.sidebarpanel.master.teacher")) {
            targetModule = "Guru";
        } else if (moduleKey.equals("ui.sidebarpanel.master.student")) {
            targetModule = "Peserta Didik";
        } else if (moduleKey.equals("ui.sidebarpanel.attendance.kiosk")) {
            targetModule = "KiosK";
        } else if (moduleKey.equals("ui.sidebarpanel.attendance.riwayat")) {
            targetModule = "Riwayat";
        } else if (moduleKey.equals("ui.sidebarpanel.attendance.analisis")) {
            targetModule = "Analisis";
        } else if (moduleKey.equals("ui.sidebarpanel.settings.general")) {
            targetModule = "General";
        } else if (moduleKey.equals("ui.sidebarpanel.settings.security")) {
